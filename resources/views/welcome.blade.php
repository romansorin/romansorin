  ...
  <div class="hero-body">
    <div class="container hero-wrapper">
      <div class="container">
        ...
        <div class="columns">
          <div class="column is-two-thirds">
            <h2 class="subtitle animated fadeInUp fast has-text-black-ter is-size-4 is-size-5-mobile" id="description">I
              design and build mobile and web applications for startups, businesses, and entrepreneurs. As a passionate
              and detail-oriented remote developer, I strive to continuously improve my qualifications and increase
